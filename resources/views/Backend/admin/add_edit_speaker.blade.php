                        ...
                        <div class="breadcrumb-body">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="{{url('admin/all-speaker')}}">All Speaker</a></li>
              ...
              <div class="row">
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form action="{{route('admin.speaker_add_edit')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="name"><span class="text-danger">*</span>Name</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="name" placeholder="Enter Speaker Name" 
                        ...
                        @if($photo != '')
                          <div class="row mb-3">
                              ...
                              <div class="col-sm-10">
                                    ...
                                    <img src="{{ url('storage/uploads/Speaker/'.$photo) }}" width="200" height="200" class="rounded">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" name="designation" id="designation" placeholder="Enter Speaker Designation" 
                        ...
                        @error('des')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                        <input type="hidden" name="speaker_id" value="{{ $id }}">
                        <div class="row">
                          <div class="col-sm-2">
