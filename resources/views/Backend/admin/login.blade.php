...
>
  <head>
    ...
    <title>Login Page | HRSUMMIT ADMIN PANEL</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="{{url('admin')}}" class="app-brand-link gap-2">
                    <img src="{{ url('storage/uploads/Gallery/'.$setting->app_logo) }}" width="150">
                </a>
              </div>
              <!-- /Logo -->
              <br>
              <h5 class="mb-2 text-center">HRSUMMIT <br>ADMIN PANEL</h5>
