                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-12">
                        <div class="card-body">
                          ...
                          <a href="{{url('admin/add-user')}}" class="btn btn-success btn-alignment"><i class='bx bxs-plus-circle'></i>&nbsp;Add</a>
                          <br>
                          <div class="card">
                      ...
                      @if(isset($all_user[0]))
                        @foreach($all_user as $row)
                            <tr>
                                ...
                                <td>
                                @if($row->status == 1)
                                                                <a href="{{url('admin/change-user-status/'.'0'.'/'.$row->id)}}" 
                                                            ...
                                                            @else
                                                                <a href="{{url('admin/change-user-status/'.'1'.'/'.$row->id)}}" 
                                                            ...
                                                            <a href="{{url('admin/edit-user/'.$row->id)}}" class="item item-btn" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>Edit</span>">
