                      ...
                      <div class="col-sm-12">
                        <div class="card-body">
                          <div class="breadcrumb-body">
                            <h5 class="card-title text-primary">All Feedback</h5>
                      ...
                      @if(isset($all_feedback[0]))
                        @foreach($all_feedback as $row)
                            <tr>
                                ...
                                <td>
                                @if($row->status == 1)
                                                                <a href="{{url('admin/change-feedback-status/'.'0'.'/'.$row->id)}}" 
                                                            ...
                                                            @else
                                                                <a href="{{url('admin/change-feedback-status/'.'1'.'/'.$row->id)}}" 
                                                            ...
                                                            <a href="{{url('admin/view-feedback/'.$row->id)}}" class="item item-btn" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" title="" data-bs-original-title="<span>View</span>">
                                                                <i class='bx bxs-binoculars text-info'></i>
                                                                </a> &nbsp;
                                                                
                                                            <a href="{{url('admin/delete-feedback/'.$row->id)}}" 
